...
export MODEL_NAME=Qwen3-0.6B-int4-awq
export EXPECTED_COMPONENTS=llm
export NAS_RELATIVE_DIR=10-1-TensorRT-Edge-LLM-models/Orin-Nano-8GB/JetPack-7.2_R39.2/v0.9.0/Qwen3-0.6B/Vanilla-INT4-AWQ
