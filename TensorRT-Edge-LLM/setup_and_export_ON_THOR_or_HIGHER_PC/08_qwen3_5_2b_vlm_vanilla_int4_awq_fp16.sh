...
export MODEL_NAME=Qwen3.5-2B-vlm-int4-awq-fp16
export EXPECTED_COMPONENTS=llm,visual
export NAS_RELATIVE_DIR=10-1-TensorRT-Edge-LLM-models/Orin-Nano-8GB/JetPack-7.2_R39.2/v0.9.0/Qwen3.5-2B/VLM-Vanilla-INT4-AWQ-FP16
